...
log('카드에 모둠 · 국가명', firstCardText.includes('1모둠') && firstCardText.includes('덴마크'));
log('대표 사진 · 소개 문구 자리표시자 없음', (await user.locator('.product-media, .product-tagline').count()) === 0 && !firstCardText.includes('자리표시자'));
